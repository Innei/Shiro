...
export const LinkCardDemo1: DocumentComponent = () => (
  <LinkCard id="notes/145" source={LinkCardSource.MixSpace} />
)
...
export const LinkCardDemo2: DocumentComponent = () => (
  <LinkCard id="innei/innei" source={LinkCardSource.GHRepo} />
)
...
export const LinkCardDemo3: DocumentComponent = () => (
  <LinkCard id="notes/1451" source={LinkCardSource.MixSpace} />
)
...
export const LinkCardDemo4: DocumentComponent = () => (
  <LinkCard id="innei/shiro/132" source={LinkCardSource.GHPr} />
)
