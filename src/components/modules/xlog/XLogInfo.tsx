    ...
    >
      ...
      >
        <div className="flex w-full items-center justify-between">
          <span className="flex grow items-start space-x-2">
            <SafeIcon />
            <span>
          ...
          <IcRoundKeyboardArrowDown
            className={clsx(
              !collapse ? '' : 'rotate-180',
              'mt-0.5 self-start text-lg transition-transform duration-200 ease-linear',
            )}
          />
        </div>
      </div>
      <CollapseContent isOpened={collapse}>
        <div className="w-full overflow-hidden py-2 text-sm opacity-90 [&_a]:break-all">
          {sections}
        </div>
      </CollapseContent>
    </div>
