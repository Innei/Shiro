...
export const Select = function Select<T>(
  ...
  return (
    ...
    >
      ...
      <SelectImpl.Portal>
        <SelectImpl.Content className="z-[1990] rounded-lg border border-zinc-200 bg-zinc-50/80 backdrop-blur dark:border-neutral-800 dark:bg-neutral-900/60">
...
const SelectItem = ({
  ...
  <SelectImpl.Item
    className="flex cursor-auto items-center justify-between rounded-xs px-3 py-1 hover:bg-zinc-200 dark:hover:bg-neutral-800"
    {...props}
    ref={forwardedRef}
  >
