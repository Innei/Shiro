...
const bgColorMap = {
  warning: 'bg-amber-50 dark:bg-amber-300/10',
  info: 'bg-blue-50 dark:bg-blue-300/10',
  success: 'bg-green-50 dark:bg-green-300/10',
  error: 'bg-red-50 dark:bg-red-300/10',
}
...
export const Banner: FC<{
  ...
  return (
    <div
      className={clsx(
        'flex flex-col items-center gap-4 rounded-md border p-6 text-neutral-900 dark:text-[#c4c4c4] md:flex md:flex-row',
